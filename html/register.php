      ...
      <form action="../php/login-register/register-back.php" method="POST">
        ...
        <div class="formbold-form-step-1 active">
          ...
          <style>
            ...
            /* Reducir el tamaño de los mensajes de validación */
            #passwordFeedback p {
              font-size: 12px;
              /* Tamaño más pequeño */
              margin: 2px 0;
              /* Espacio entre líneas reducido */
            }

            /* Reducir el tamaño del estado de la contraseña */
            #passwordStatus {
              font-size: 12px;
              /* Texto más pequeño */
              margin-top: 5px;
            ...
            /* Ajustar el tamaño del icono para mostrar/ocultar contraseña */
            .toggle-icon {
              font-size: 14px;
          ...
          <!-- <div>
            ...
            <p id="passwordStatus" class="not-secure">Contraseña no segura</p>
          </div> -->
          <div>
            <label for="password" class="formbold-form-label">Password</label>
            <div class="password-toggle">
